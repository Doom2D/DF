...
begin
  ...
  g_Texture_CreateWADEx('TEXTURE_PLAYER_ARMOR1HUD', GameWAD+':TEXTURES\ARMOR1');
  g_Texture_CreateWADEx('TEXTURE_PLAYER_ARMOR2HUD', GameWAD+':TEXTURES\ARMOR2');
...
begin
  ...
  g_Texture_Delete('TEXTURE_PLAYER_ARMOR1HUD');
  g_Texture_Delete('TEXTURE_PLAYER_ARMOR2HUD');
